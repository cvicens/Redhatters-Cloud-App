    ...
    io.sockets.on('connection', function(socket) {
        ...
        socket.on(NEXT_QUESTION_MESSAGE, function(data) {
            ...
            if (currentQuiz) {
                ...
                io.sockets.in('room').emit(NEW_QUESTION_MESSAGE, {currentQuestionIndex: currentQuestionIndex, question: question});
                
                currentQuiz.currentQuestionIndex++;
            } else {
                console.error ('NEXT_QUESTION_MESSAGE ERROR: Live quiz not found with liveQuizId', liveQuizId);
            }
